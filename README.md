...
1. Choose a large prime number p and an elliptic curve defined by the equation
   𝑦^2 = 𝑥^3 + 𝑎𝑥 +𝑏 mod p along with a base point G on the curve.
...
![image](https://github.com/user-attachments/assets/6e53f51f-02af-4777-bf4c-b99831fc489f)
